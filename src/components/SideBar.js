...
const SideBar = () => {
  ...
  return (
    <>
      <aside className="flex md:flex-col items-center md:py-5 p-3 justify-between md:space-y-5 m-4 md:w-1/6 bg-white rounded-xl text-[#6C7894] md:h-screen max-h-[768px] overflow-y-auto">
